...
const cors = require("cors") //importing corse(cross origin resource sharing) which allows us to share our api info with our react application on the front end
